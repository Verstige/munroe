...
interface RenaChatInterfaceProps {
  userName?: string;
  onSendMessage?: (message: string) => void;
  className?: string;
}

const RenaChatInterface: React.FC<RenaChatInterfaceProps> = ({
  userName = "User",
  onSendMessage,
  className = ""
}) => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      type: 'ai',
      content: `Hello ${userName}! I'm Rena AI, your intelligent project assistant. I can help you with project management, task tracking, time analysis, and much more. What would you like to know?`,
      timestamp: new Date()
    }
  ]);
...
export default RenaChatInterface;
